        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mt-1">
              Total Users with Addresses: {userSummaries.length}
            </p>
          </div>
        </div>
        ...
        <table className="w-full text-left">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr className="bg-gray-50 text-gray-600 text-sm uppercase tracking-wider">
              <th className="px-6 py-4 font-semibold border-b">User Info</th>
              <th className="px-6 py-4 font-semibold border-b">Contact</th>
              <th className="px-6 py-4 font-semibold border-b">
                Default Location
              </th>
              <th className="px-6 py-4 font-semibold border-b">Region & ZIP</th>
              <th className="px-6 py-4 font-semibold border-b">Total saved</th>
            </tr>
          </thead>
              ...
              filteredData.map((user) => (
                ...
                >
                  <td className="px-2 py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] font-mono text-gray-600 flex items-center gap-1 mt-0.5">
                  ...
                  <td className="px-6 py-5 text-center">
                    <span className="inline-flex items-center justify-center bg-gray-800 text-white text-[10px] font-black h-7 w-12 rounded-full shadow-inner">
                      {user.totalAddresses}
                    </span>
                  </td>
                </tr>
